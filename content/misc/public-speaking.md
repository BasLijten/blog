...
| Date | Title | Location | Description |
--- | --- | --- | ---
02-05 | How to use PowerBI to improve SharePoint hosting | SharePoint & Sushi (Portiva) | Interactive session on how to use PowerBI to parse and investigate logs
